...
namespace details {
  ...
  template<typename T>
  jsi::Value Copy(const T& value) {
    const jsi::Value& jsiValue = value;
    if (jsiValue.isUndefined()) {
        return jsi::Value::undefined();
    } else if (jsiValue.isNull()) {
        return jsi::Value::null();
    } else if (jsiValue.isBool()) {
        return jsiValue.getBool();
    } else if (jsiValue.isNumber()) {
        return jsiValue.getNumber();
    } else {
        return {((napi_env)value.Env())->rt, jsiValue};
    }
  }
} // details
...
inline Value::Value(const Value& other)
  : _env{other._env}, _value{details::Copy(other)} {
}
...
inline Object::Object(napi_env env, jsi::Value value)
  : Value{env, std::move(value)} {
  if (_value.isObject()) {
    _object = _value.getObject(env->rt);
  }
}
...
inline Object::Object(const Object& other)
  : Object{other._env, details::Copy(other)} {
}
...
inline void Object::Set(const Value& key, const ValueType& value) {
  _object->setProperty(_env->rt, ((const jsi::Value&)key).toString(_env->rt), static_cast<jsi::Value&&>(Value::From(_env, value)));
}
...
inline Array::Array(napi_env env, jsi::Value value)
  ...
  if (_object.has_value()) {
    _array = _object->getArray(env->rt);
  }
}
...
inline Array::Array(const Array& other)
  : Array{other._env, details::Copy(other)} {
}
...
inline ArrayBuffer::ArrayBuffer(napi_env env, jsi::Value value)
  : Object{env, std::move(value)} {
  if (_object.has_value()) {
    _arrayBuffer = _object->getArrayBuffer(env->rt);
  }
}
...
inline ArrayBuffer::ArrayBuffer(const ArrayBuffer& other)
  : ArrayBuffer{other._env, details::Copy(other)} {
}
...
inline Function::Function(napi_env env, jsi::Value value)
  : Object{env, std::move(value)} {
  if (_object.has_value()) {
    _function = _object->getFunction(env->rt);
  }
}
...
inline Function::Function(const Function& other)
  : Function{other._env, details::Copy(other)} {
}
